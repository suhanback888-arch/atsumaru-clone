      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">Your favorite manga, manhwa, and manhua reader.</p>
            <div className="flex gap-3">
              <a href="#" className="text-gray-500 hover:text-primary transition-colors" title="Discord">
              ...
              <a href="#" className="text-gray-500 hover:text-primary transition-colors" title="Reddit">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-6 border-t border-white/5 text-center text-xs text-gray-600">
          Atsumaru Clone &mdash; Built with Next.js &bull; Data from MangaDex, Asura Scans, MangaFire, MangaKakalot, Manganato, MangaPill
        </div>
      </div>
    </footer>
  );
